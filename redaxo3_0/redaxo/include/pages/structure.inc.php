 ...
 *  
 * @package redaxo3 
 * @version $Id: structure.inc.php,v 1.53 2006/03/16 19:38:19 kills Exp $ 
 */
...
elseif (isset ($catdelete_function) and $catdelete_function != "" && $edit_id != "" && $KATPERM && !$REX_USER->isValueOf("rights", "contentEditor[]"))
{
  // --------------------- KATEGORIE DELETE
  $KAT = new sql;
...
elseif (isset ($function) and $function == "add_category" && $KATPERM && !$REX_USER->isValueOf("rights", "contentEditor[]"))
{
  // --------------------- KATEGORIE ADD
...
if ($KATPERM && !$REX_USER->isValueOf("rights", "contentEditor[]"))
...
if (isset ($function) and $function == "add_cat" && $KATPERM && !$REX_USER->isValueOf("rights", "contentEditor[]"))
{
  // --------------------- KATEGORIE ADD FORM
  $echo .= "
      <tr>
