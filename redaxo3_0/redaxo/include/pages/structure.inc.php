 ...
 *
 * @package redaxo3
 * @version $Id: structure.inc.php,v 1.104 2007/09/04 18:41:56 tbaddade Exp $
 */
...
{
  $add_category = '<a href="index.php?page=structure&amp;category_id='.$category_id.'&amp;function=add_cat&amp;clang='.$clang.'"><img src="pics/folder_plus.gif" alt="'.$I18N->msg("add_category").'" title="'.$I18N->msg("add_category").'" /></a>';
}
...
if ($category_id > -1)
{
  ...
  if ($KATPERM && !$REX_USER->hasPerm('editContentOnly[]'))
  {
    $art_add_link = '<a href="index.php?page=structure&amp;category_id='. $category_id .'&amp;function=add_art&amp;clang='. $clang .'"><img src="pics/document_plus.gif" alt="'. $I18N->msg('article_add') .'" title="' .$I18N->msg('article_add') .'" /></a>';
  }
