 ...
 *  
 * @package redaxo3 
 * @version $Id: structure.inc.php,v 1.49 2006/03/09 20:05:39 kills Exp $ 
 */
...
if ($KATPERM && !$REX_USER->isValueOf("rights", "onlyCatEdit[]"))
...
for ($i = 0; $i < $KAT->getRows(); $i++)
{
  ...
  if ($KATPERM)
  {
    ...
    if (isset ($edit_id) and $edit_id == $i_category_id and isset ($function) and $function == "edit")
    {
      ...
      if (!$REX_USER->isValueOf("rights", "onlyCatEdit[]"))
