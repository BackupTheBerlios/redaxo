 ...
 *  
 * @package redaxo3 
 * @version $Id: medienpool.inc.php,v 1.114 2007/04/24 20:12:30 tbaddade Exp $ 
 */ 
  ...
  if ($media_method == 'add_cat')
  {
    echo '
      <tr class="rex-trow-actv">
        <td><img src="pics/folder.gif" alt="'.$I18N->msg('pool_kat_create').'" title="'.$I18N->msg('pool_kat_create').'" /></td>
        <td></td>
        <td>
