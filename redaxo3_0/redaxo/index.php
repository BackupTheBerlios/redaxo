 ...
 *  
 * @package redaxo3
 * @version $Id: index.php,v 1.32 2006/03/06 12:36:34 tbaddade Exp $
 */ 
...
} else
{
  ...
  $REX_LOGIN->setLoginquery("SELECT * FROM ".$REX['TABLE_PREFIX']."user WHERE login = 'USR_LOGIN' and psw = 'USR_PSW'");
